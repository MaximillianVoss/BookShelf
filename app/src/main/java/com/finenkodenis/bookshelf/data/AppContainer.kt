...
class DefaultAppContainer(context: Context) : AppContainer {
    ...
    private val localBookServerBaseUrl = "http://10.0.2.2:8000/"
    ...
    private val localBookServerRetrofit: Retrofit = Retrofit.Builder()
        .addConverterFactory(GsonConverterFactory.create())
        .baseUrl(localBookServerBaseUrl)
        .build()
    ...
    private val localBookServerService: LocalBookServerService by lazy {
        localBookServerRetrofit.create(LocalBookServerService::class.java)
    }
